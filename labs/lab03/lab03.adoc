...
+
$ cp -rf ../lab02/data-jpa-spring-boot .
...
. Add the Spring Boot Actuator dependency the following file: /data-jpa-spring-boot/pom.xml
+
[source, xml]
---------------------------------------------------------------------
<dependency>
...
. Run the updated _data-jpa-spring-boot_ application:
+
